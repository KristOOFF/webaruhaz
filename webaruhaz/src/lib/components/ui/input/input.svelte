...
{#if type === "file"}
	<input
		...
		class={cn(
			...
			"focus-visible:border-white/50 dark:focus-visible:border-white/30 focus-visible:ring-2 focus-visible:ring-white/50 dark:focus-visible:ring-purple-400/50",
